...
/**
 * Extract the list of inputs from a plugins config and account for it being optional.
 */
...
/**
 * Build all inputs available to the engine by combining the PluginInputs and ConfigInputs
 */
