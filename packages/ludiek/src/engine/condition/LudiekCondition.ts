...
/**
 * Extract the list of condition from a plugins config and account for it being optional.
 */
...
/**
 * Build all condition available to the engine by combining the PluginConditions and ConfigConditions
 */
