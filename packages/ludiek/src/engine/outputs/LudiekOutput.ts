...
/**
 * Extract the list of outputs from a plugins config and account for it being optional.
 */
...
/**
 * Build all outputs available to the engine by combining the PluginOutputs and ConfigOutputs
 */
